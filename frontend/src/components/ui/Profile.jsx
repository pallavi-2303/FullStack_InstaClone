            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-2">
                ...
                {isLoggedInUser ? (
                  ...
                  <Button className="bg-[#0095F6] hover:bg-[#2a7db4] h-8">
                    Unfollow
                  </Button>
                )}
              </div>
             ...
             <Badge variant="secondary" className="w-fit h-6"><AtSign/><span className="pl-2">{userProfile?.userName}</span></Badge>
             <span>Learn Code with Pallavi Singh</span>
             <span>Transform your dreams into reality</span>
...
<span className={`py-3 cursor-pointer`}  onClick={()=>handleTabChange('reels')}>REELS</span>
<span className={`py-3 cursor-pointer`}  onClick={()=>handleTabChange('tags')}>TAGS</span>
</div>
